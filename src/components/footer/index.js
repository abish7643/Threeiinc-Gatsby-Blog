                ...
                <div className="footer__hero">
                    <div className="footer__contents">
                        <div className="newsletter__form">
                            <p>
                                Want to keep up with the latest posts? Subscribe
                                to our newsletter!
                            </p>
                        ...
                        <div className="footer__contact__one">
                            ...
                            <p>
                                Each I in 3I is intricately designed to match
                                the natural genetic code, the imaginary number
                                of complex world, the structural integrity of
                                the strongest bridge, the quintessential paragon
                            ...
                            >
                                ...
                                <a
                                    href="https://www.facebook.com/admin.threei.1/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
                                ...
                                <a
                                    href="https://www.twitter.com/inc_3i/"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                >
